...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]Modbox[/B][/COLOR]Wizard'
BUILDERNAME = 'ModboxWizard'
EXCLUDES = [ADDON_ID, 'repository.modboxwiz']
# Text File with build info in it. Please read https://github.com/a4k-openproject/plugin.program.openwizard/wiki/Installing-Builds
BUILDFILE = 'https://modbox.000webhostapp.com/19/Builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Modbox[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Modbox[/B][/COLOR]Wizard'
